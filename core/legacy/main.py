...
from utils import aerca_utils as utils
import warnings
...
def main(argv):
    ...
    if _LEGACY_IMPORT_ERROR is not None:
        raise SystemExit(
            "This legacy AERCA runner requires the upstream AERCA args/ and datasets/ "
            "packages, which are not part of this refactored project. Use the CausClass "
            "entry points under core/ instead."
        )
