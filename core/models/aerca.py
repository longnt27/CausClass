...
import torch
from utils.aerca_utils import (compute_kl_divergence, sliding_window_view_torch,
...
class AERCA(nn.Module):
    def __init__(self, num_vars: int, hidden_layer_size: int, num_hidden_layers: int, device: torch.device,
        ...
        # Save generated checkpoints outside the source tree.
        self.save_dir = os.path.join(OUTPUT_DIR, 'saved_models')
